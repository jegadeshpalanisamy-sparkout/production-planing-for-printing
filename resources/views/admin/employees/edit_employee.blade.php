            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mt-12">
                <div class="p-6 text-gray-900">
                    <div class="max-w-lg mx-auto bg-white p-8 rounded-lg shadow-md">
                        <h2 class="text-2xl font-bold mb-6 text-gray-800">Edit Employee Form</h2>
                        
                        <form action="{{ route('admin.update_employee',$getEmployee->id) }}" method="post">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" id="emp_name" name="emp_name" placeholder="Enter employee name" value="{{ $getEmployee->emp_name }}"
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" id="phone" name="phone" placeholder="Enter phone number" value="{{ $getEmployee->phone }}"
                            ...
                            <div class="mb-4">
                                ...
                                <input type="email" id="email" name="email" placeholder="Enter email"  value="{{ $getEmployee->email }}"
                                    class="shadow border rounded w-full py-2 px-3 text-gray-700 leading-tight" required>
                            </div>
                            @error('email')
                                <div class="text-red-500">{{ $message }}</div>
